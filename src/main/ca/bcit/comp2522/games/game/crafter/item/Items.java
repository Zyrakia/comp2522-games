...
/**
 * Holds all default items for the crafter game.
 *
 * @author Ole Lammers
 * @version 1.0
 */
public final class Items {
    ...
    /** Tier 1 - Sapling. */
    public static final Item SAPLING = new Item("Sapling", "Could be useful for something sturdy.");

    /** Tier 1 - Wood. */
    public static final Item WOOD = new Item("Wood", "The backbone of many things.");

    /** Tier 1 - Stone. */
    public static final Item STONE = new Item("Stone", "Feels rough. Maybe it’s time to smooth things out?");

    /** Tier 1 - Cobblestone. */
    public static final Item COBBLESTONE = new Item("Cobblestone", "Perfect for starting something new.");

    /** Tier 2 - Plank. */
    public static final Item PLANK = new Item("Plank", "Refined but still practical.");
    ...
    /** Tier 4 - Gold Ore. */
    public static final Item GOLD_ORE = new Item("Gold Ore", "There’s something regal about it.");

    /** Tier 4 - Gold Ingot. */
    public static final Item GOLD_INGOT = new Item("Gold Ingot", "Bright enough to dazzle, strong enough to craft.");

    /** Tier 4 - Redstone. */
    public static final Item REDSTONE = new Item("Redstone", "It hums faintly in your hand.");
